<template>
<MainLayout v-if="user" :header="user.name  + '\'s Follows'">
      ...
      <div class="col-xl-8 col-lg-7">
          ...
          <div class="card shadow mb-4">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Follows Profile Details</h6>
              </div>
 ...
 name: 'Followings',
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      const res = await store.dispatch('getFollowings', props.userId)
